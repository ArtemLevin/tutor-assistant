...
def install_lesson_journal(window) -> LessonJournalCloseoutPage:
    page = LessonJournalCloseoutPage(
        window.crm_store,
...
def _restore_extended_period(page: LessonJournalCloseoutPage) -> None:
