...
2. Используй подтверждённый `source/transcript.txt` как основной источник. Если существуют
   `teacher_transcript.txt` и `student_transcript.txt`, различай объяснения преподавателя,
   самостоятельные ответы, вопросы и ошибки ученика.
...
Работай в уже созданной ветке и draft PR занятия. Не создавай параллельную ветку для тех же
материалов. Оставляй PR в draft до появления всех артефактов и успешных отчётов проверки.
